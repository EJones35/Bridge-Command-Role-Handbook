# Bridge Command Handbook

A fan-made reference handbook for [Bridge Command](https://www.bridgecommand.co.uk/), covering roles, responsibilities, and gameplay guidance for all crew positions.
...
- Main role description and responsibilities
- Subteam values
- Bridge location (Havock and Takanami layouts)
- Required skills
- Example callouts (do's and don'ts)
- Common mistakes
- Advanced tips
...
This is a static site with no build step required. To view locally:

```bash
git clone https://github.com/EJones35/Bridge-Command-Handbook.git
cd Bridge-Command-Handbook
```
...
If you spot incorrect information or want to suggest improvements, feel free to open an issue or submit a pull request. You can also contact "Cadet Jones" on the Bridge Command Discord.

## Disclaimer

This handbook is not affiliated with or endorsed by Bridge Command. All game-related content belongs to its respective owners. This is a community resource created to help players enjoy the experience.
